...
export default function InsightBanner({ message }: InsightBannerProps) {
  return (
    <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-brand-bg border border-brand-border">

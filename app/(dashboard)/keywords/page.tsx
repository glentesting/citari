        ...
        {loading ? (
          ...
          <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
            <div className="grid grid-cols-[1fr_90px_80px_80px_120px_80px_70px_60px_40px] border-b border-gray-200 bg-gray-50">
              ...
              <div className="px-3 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide text-center">Volume</div>
              ...
              <div className="px-3 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide text-center">Opp.</div>

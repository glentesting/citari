        ...
        {loading ? (
          ...
          <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
            <div className="grid grid-cols-[1fr_90px_80px_80px_120px_80px_70px_60px_40px] border-b border-gray-200 bg-gray-50">
              ...
              <div className="px-3 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide text-center relative group">Volume <span className="inline-block w-3.5 h-3.5 rounded-full bg-gray-200 text-gray-500 text-[9px] leading-[14px] text-center cursor-help ml-0.5">i<span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1 px-2 py-1 bg-gray-900 text-white text-[10px] rounded whitespace-normal w-48 text-left font-normal normal-case opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">Monthly search volume — how many people search this term per month. Dashes mean data hasn&apos;t been fetched yet — click Refresh Rankings.</span></span></div>
              ...
              <div className="px-3 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide text-center relative group">Opp. <span className="inline-block w-3.5 h-3.5 rounded-full bg-gray-200 text-gray-500 text-[9px] leading-[14px] text-center cursor-help ml-0.5">i<span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1 px-2 py-1 bg-gray-900 text-white text-[10px] rounded whitespace-normal w-44 text-left font-normal normal-case opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">Opportunity score — high means good potential based on volume vs difficulty. Click Refresh Rankings to populate.</span></span></div>

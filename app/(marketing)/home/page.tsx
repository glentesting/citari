...
const plans = [
  {
    ...
    desc: '2 clients · 50 prompts',
    features: ['Daily AI scans', 'Basic GEO content', 'Schema generator', 'Email alerts'],
    cta: 'Start Free Trial',
  },
  {
    name: 'Professional', price: 89,
    desc: '10 clients · 500 prompts',
    features: ['All Starter features', 'White-label client portal', 'Consultant mode', 'CMS integrations', 'Competitive briefs', 'Predictive alerts'],
    popular: true,
    cta: 'Start Free Trial',
  },
  {
    name: 'Agency', price: 199,
    desc: 'Unlimited clients & prompts',
    features: ['All Professional features', 'Consultant playbook', 'Cross-client benchmarks', 'Multilingual tracking', 'Priority support', 'Custom branding'],
    cta: 'Start Free Trial',
  },
]
    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/signup" className="px-4 py-2 text-sm font-semibold text-white bg-brand rounded-lg hover:bg-brand-dark transition-colors">
              Start Free Trial
            </Link>
          </div>
        </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="mt-8 flex items-center justify-center gap-4">
            <Link href="/signup" className="px-6 py-3 text-base font-semibold text-white bg-brand rounded-lg hover:bg-brand-dark transition-colors">
      ...
      <section className="py-16 px-6 bg-[#F9FAFB]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
            67% of buying decisions now start with an AI model query. When someone asks ChatGPT
            for the best solution in your category, your competitors might be the answer — not you.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {industries.map((ind) => (
              <span key={ind} className="px-4 py-2 bg-brand-bg text-brand text-sm font-medium rounded-full border border-brand-border">
                {ind}
              </span>
            ))}
          </div>
      ...
      <section className="py-20 px-6" id="pricing">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-3 gap-6">
            {plans.map((plan) => (
              <div key={plan.name} className={`bg-white border rounded-xl p-6 ${
                plan.popular ? 'border-brand ring-1 ring-brand' : 'border-gray-200'
              }`}>
                {plan.popular && (
                ...
                <Link href="/signup"
                  className={`block w-full mt-6 py-3 text-center text-sm font-semibold rounded-lg transition-colors ${
                    plan.popular
      ...
      <section className="py-20 px-6 bg-brand">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link href="/signup" className="inline-block px-8 py-3 text-brand font-semibold bg-white rounded-lg hover:bg-gray-100 transition-colors">
            Get Started Free
          </Link>
        </div>
      </section>
